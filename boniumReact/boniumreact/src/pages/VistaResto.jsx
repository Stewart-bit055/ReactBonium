...
const VistaResto = ({ onLogout, onNavigate }) => {
  const [vista, setVista] = useState("crear-producto");
  return (
    <div style={{
      minHeight: "100vh",
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ textAlign: "center", cursor: "pointer" }} onClick={() => setVista("crear-producto") }>
              ...
              <div style={{ color: "#fff", fontWeight: 700, fontSize: 15, marginTop: 8, borderBottom: "3px solid #1ec9a3", paddingBottom: 2 }}>CREAR PRODUCTO</div>
            </div>
            <div style={{ textAlign: "center", cursor: "pointer" }} onClick={() => setVista("historial") }>
              ...
              <div style={{ color: "#fff", fontWeight: 700, fontSize: 15, marginTop: 8 }}>HISTORIAL</div>
            </div>
            <div style={{ textAlign: "center", cursor: "pointer" }} onClick={() => setVista("cuenta-cobro") }>
              <svg width="56" height="56" fill="none" stroke="#fff" strokeWidth="2.5" viewBox="0 0 48 48">
                <rect x="8" y="12" width="32" height="28" rx="6" fill="none"/>
                <path d="M16 20h16M16 28h16" stroke="#fff" strokeWidth="2.5"/>
              </svg>
              <div style={{ color: "#fff", fontWeight: 700, fontSize: 15, marginTop: 8 }}>CUENTA DE COBRO</div>
              <div style={{ color: "#b2f2e5", fontSize: 11, fontStyle: "italic", marginTop: 2 }}>Gestión gastronómica · Bonium</div>
            </div>
          </div>
        </div>
        {/* Contenido principal */}
        <div style={{ padding: 32, background: "#f8fafc" }}>
          {vista === "crear-producto" && <CrearProductoForm />}
          {vista === "historial" && <HistorialPedidos />}
          {vista === "cuenta-cobro" && <CuentaCobro />}
        </div>
      </div>
    </div>
  );
